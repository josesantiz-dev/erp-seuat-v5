                    ...
                    <ul class="nav nav-pills nav-sidebar nav-legacy text-sm nav-compact flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo BASE_URL ?>/Grupo" class="nav-link">
                                <i class="ml-3 mr-2" data-feather="smile"></i>
                                <p>
                                    Grupos
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo BASE_URL ?>/Documento" class="nav-link">
                                <i class="ml-3 mr-2" data-feather="folder"></i>
                                <p>
                                    Documentos
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo BASE_URL ?>/Convocatoria" class="nav-link">
