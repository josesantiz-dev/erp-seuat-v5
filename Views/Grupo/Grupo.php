<?php
headerAdmin($data);
getModal("Grupo/modalNuevoGrupo", $data);
getModal("Grupo/modalEditGrupo", $data);
?>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-5">
                        <ol class="breadcrumb float-sm-right btn-block">
                            <button type="button" id="btnNuevoGrupo" onclick="openModal();" class="btn btn-inline btn-primary btn-sm btn-block" data-toggle="modal" data-target="#modalNuevoGrupo">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                <table id="tablegrupos" class="table table-bordered table-striped table-hover table-sm">
                                    <thead>
                                        <tr>
                                            <th width="7%">#</th>
                                            <th>Grupo</th>
