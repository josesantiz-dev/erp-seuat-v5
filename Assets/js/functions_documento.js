...
function fnEliminar(value)
{
  ...
  formEditDocumento.onsubmit = function (e) {
    ...
    /* let url = `${base_url}/Documento/setEditDocumento`;
    let datosDocEdit = new FormData(document.getElementById('formNuevoDocumentoEdit'));
    fetch(url,{
      method : 'POST',
      body: datosDocEdit
    })
  ...
  if (nombreDocumentoEdit == "" || nombreTipoDocumentoEdit == "" || cantidadDocumentosEdit == "" || documentosOriginalesEdit == "") {
    Swal.fire({
      icon: "error",
      title: "Campo vacio",
      text: "FAVOR DE REVISAR!",
